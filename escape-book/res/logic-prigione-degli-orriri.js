    ...
    methods: { 
        ...
        addClessidra: function(value){
            ...
            Vue.nextTick(function() {
                if(main.gameStats.clessidre === main.MAX_CLESSIDRE) alert(main.$t("messaggi.go_to_6666"));
            });
        },
        ...
        saveToLocalDB: function(){
            localStorage.setItem('EB_prigione_orrori', JSON.stringify(this.gameStats));
        },
        loadFromLocalDB: function(){
            let data = JSON.parse(localStorage.getItem('EB_prigione_orrori'));
            if(data == null) {
