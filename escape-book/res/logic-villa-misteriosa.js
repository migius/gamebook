    ...
    methods: { 
        ...
        addClessidra: function(value){
            ...
            Vue.nextTick(function() {
                if(main.gameStats.clessidre === 8) alert(main.$t("messaggi.go_to_1933"));
                if(main.gameStats.clessidre === main.MAX_CLESSIDRE) alert(main.$t("messaggi.go_to_4123"));
            });
        },
        ...
        saveToLocalDB: function(){
            localStorage.setItem('EB_villa_misteriosa', JSON.stringify(this.gameStats));
        },
        loadFromLocalDB: function(){
            let data = JSON.parse(localStorage.getItem('EB_villa_misteriosa'));
            if(data == null) {
