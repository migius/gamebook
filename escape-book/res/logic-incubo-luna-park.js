    ...
    methods: { 
        ...
        addClessidra: function(value){
            ...
            Vue.nextTick(function() {
                if(main.gameStats.clessidre === main.MAX_CLESSIDRE) alert(main.$t("messaggi.go_to_1111"));
            });
        },
        ...
        saveToLocalDB: function(){
            localStorage.setItem('EB_incubo_luna_park', JSON.stringify(this.gameStats));
        },
        loadFromLocalDB: function(){
            let data = JSON.parse(localStorage.getItem('EB_incubo_luna_park'));
            if(data == null) {
