const messages = {
    it: {        
        ...
        messaggi: {
            ...
            go_to_299: "Vai al 299.",
            salute_0: "Il tuo fisico ha ceduto e sei sconfitta. Vuoi iniziare una nuova partita resettando tutte le statistiche?",
            rigenerazione_0: "I tuoi poteri svaniscono. Vuoi iniziare una nuova partita resettando tutte le statistiche?",
        },        
        ...
        footer: {
            ...
            howto: "Come funziona",
            howto_content_laura: `Questa scheda è di ausilio alla lettura del librogame @:link_amazon di Francesco Di Lazzaro edito da Watson Edizioni.<br>
            ...
            howto_content_carmilla: `Questa scheda è di ausilio alla lettura del librogame @:link_amazon di Francesco Di Lazzaro edito da Watson Edizioni.<br>
            Per modificare i valori oscurità e rigenerazione utilizzare i pulsanti - e +.<br>
            Per aggiungere oggetti cliccare il quadrato oggetti, per rimuoverli basta cancellarne il nome.<br>
            Per segnare il sangue di Laura basta cliccare sui quadrati<br>
            Per aggiungere e rimouvere parole chiave e note utilizzare i tasti + e meno -.<br>
            <br>
            I valori presenti nella scheda (e nessun altro dato) vengono salvati nel browser e quindi anche se la pagina viene chiusa e riaperta i dati restano salvati. Non è possibile scaricare o inviare i propri dati a un altro dispositivo. Nessun dato viene inviato a server centrali, la partita rimarrà solo sul dispositivo utilizzato.<br>
            Se si vuole resettare i valori utilizzare il tasto '@:new_game'.`
        ...
        //carmilla
        registro_carmilla: "Registro Carmilla",
        oscurita: "oscurità",
        rigenerazione: "rigenerazione",
        sangue_laura: "Il sangue di Laura"
    },
    en: {  
        //todo
    },
